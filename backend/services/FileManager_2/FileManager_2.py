...
# from DocumentVersionManager import *
# from UserHistoryManager import *
# #TODO from Services.FileManager.permissions import * 
...
# # Start flask
# fileManager_2 = Blueprint('fileManager_2', __name__)

# @fileManager_2.route('/filemanagerhealth')
...
# '''
# @fileManager_2.route('/filecreate', methods = ['GET', 'POST'])
...
# '''
# @fileManager_2.route('/filemodify', methods = ['GET', 'POST'])
...
# # 4. Output: UserId, DocId, DocName, FilePath
# '''
# @fileManager_2.route('/filerename', methods = ['GET', 'POST'])
...
# '''
# @fileManager_2.route('/filegetlist', methods = ['GET', 'POST'])
# def file_GetList(user_id, method):
...
#     if(method == 'GET'):
#         userid = user_id #TODO to confirm 
#         json_str = {}
...
#         except Exception as err:
#             mess_out = 'fail'
#             logging.exception("Failure getting the list of files! "+str(err))
...
# @fileManager_2.route('/file/rename', methods=['GET', 'POST'])
# def file_rename():
#     #TODO api to rename file
#     pass

# @fileManager_2.route('/file/delete', methods=['GET', 'POST'])
# def file_delete():
#     #docid
#     #userid
...
# @fileManager_2.route('/file/view', methods=['GET', 'POST'])
# def file_view():
#     #TODO api to view file
#     pass

# @fileManager_2.route('/file/trash', methods = ['GET', 'POST'])
# def file_trash():
#     #docid
#     #userid
#     #update db
...
# @fileManager_2.route('/file/retrive', methods = ['GET','POST'])
# def file_retrive():
#     pass
