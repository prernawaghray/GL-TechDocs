...
from UserAndDocDetails import engine
...
def setReadGroupPermission(userid, docid):
    ...
    record1 = {"PId": permissionid}
    grouppermission = engine.execute(sql, **record1)
